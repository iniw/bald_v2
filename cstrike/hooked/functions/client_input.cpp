...
void __fastcall hooked::cam_think( client_input* ecx, void* edx ) {
	...
	static auto o_cam_think = g_detour.get< decltype( &cam_think ) >( "CInput::CAM_Think" );
...
void __fastcall hooked::cam_to_third_person( client_input* ecx, void* edx ) {
	...
	static auto o_cam_to_third_person = g_detour.get< decltype( &cam_to_third_person ) >( "CInput::CAM_ToThirdPerson" );
