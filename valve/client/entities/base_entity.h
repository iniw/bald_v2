...
struct base_entity : public i_client_entity {
	...
	inline auto get_anim_overlay( int i ) {
		...
		return reinterpret_cast< animation_layer* >( i * sizeof( animation_layer ) + *reinterpret_cast< size_t* >( reinterpret_cast< size_t >( this ) + offset ) );
	...
	inline auto& get_effects( ) {
		...
		return *reinterpret_cast< int* >( reinterpret_cast< size_t >( this ) + 0xF0 );
	}
